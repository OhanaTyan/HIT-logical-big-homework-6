...
HD_PWD='D:/Vivado_project/big_homework/big_homework.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_number_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_number_display.tcl -notrace
