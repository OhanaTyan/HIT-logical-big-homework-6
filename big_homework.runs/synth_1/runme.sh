...
HD_PWD='D:/Vivado_project/big_homework/big_homework.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_number_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_number_display.tcl
